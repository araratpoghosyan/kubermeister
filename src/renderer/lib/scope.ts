...
/**
 * Switch kube-context and forget everything read from the previous one. Open shells and forwards go
 * with it: main ends their streams anyway, and either one left behind names an object of the
 * cluster being left.
 */
