...
export const Route = createFileRoute('/access/clusterrolebindings_/$name')({
...
function ClusterRoleBindingDetailPage() {
    ...
    return (
        <ResourceDetail
            ...
            query={query}
            found={!!row}
            actions={<RefreshButton queryKeys={[ipcQueryKey('resources.get', { kind: 'ClusterRoleBinding', name })]} />}
