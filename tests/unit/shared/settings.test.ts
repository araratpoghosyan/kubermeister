...
describe('parseSettings', () => {
    ...
    it('resets a data section that is not usable, keeping one that is', () => {
        ...
        const defaults = { refreshIntervalSec: 12, logBufferLines: 2000, terminalFontSize: 12, forwards: [] };
        const good = { refreshIntervalSec: 30, logBufferLines: 10_000, terminalFontSize: 14, forwards: [] };
    ...
    it('lets the renderer change the refresh interval', () => {
        ...
        expect(
            mergeSettings(DEFAULT_SETTINGS, {
                data: { refreshIntervalSec: 60, logBufferLines: 2000, terminalFontSize: 12, forwards: [] },
