...
`vX.Y.Z` tag ships a stable release once its `chore(release): X.Y.Z` PR has merged. The
[CHANGELOG](CHANGELOG.md) has an Unreleased section: when your change is worth a line there, add it
